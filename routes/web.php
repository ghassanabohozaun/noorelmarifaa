...
Route::group(
    ...
    function () {
        ...
        /// posts
        Route::get('/posts/{departmentSlug?}', [FrontendController::class, 'posts'])->name('posts');
        Route::get('/posts-paging/{id?}', [FrontendController::class, 'postsPaging'])->name('posts.paging');
        Route::get('/post/{val?}', [FrontendController::class, 'post'])->name('post');
        ...
        Route::get('/photos-gallery-photos', [FrontendController::class, 'photosGalleryPhotos'])->name('get.photos.gallery.photos');
        ...
        Route::get('/get-yearly-reports-for-one-year/{year?}', [FrontendController::class, 'getYearlyReportsForOneYear'])->name('get.yearly.reports.for.one.year');
        Route::get('/monthly-reports', [FrontendController::class, 'monthlyReports'])->name('monthly.reports');
        Route::get('/get-monthly-reports-for-one-year/{year?}', [FrontendController::class, 'getMonthlyReportsForOneYear'])->name('get.monthly.reports.for.one.year');
    },
);
