    ...
    <section class="welcome-section">
        <div class="auto-container">
            ...
            @forelse($MonthlyReports as $MonthlyReport)
                        ...
                        <div class="book_btn d-none d-lg-block">
                            <div class="download_brochure d-flex align-items-center justify-content-between">
                                ...
                                <div class="download_right">
                                    <a href="{!! route('get.monthly.reports.for.one.year', $MonthlyReport->year) !!}" class="boxed-btn3-line" >
                                      {!! trans('frontend.monthly_report_for') !!}  {!! $MonthlyReport->year !!}
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                @empty
                    <h3 class="text-warning">{!! trans('frontend.no_monthly_reports_exists') !!}</h3>
                @endforelse
