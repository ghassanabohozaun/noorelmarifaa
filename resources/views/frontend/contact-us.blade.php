                    ...
                    <div class="row clearfix">
                        ...
                        <div class="column col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="d-none form-group">
                                <input type="text" name="communication_status" id="communication_status"
                                       value="0">
                            ...
                            <div class="form-group">
                                <input type="text" name="communication_sender" id="communication_sender"
                                       autocomplete="off"
                                       value="" placeholder="{!! trans('frontend.enter_sender') !!}">
                                <span class="form-text text-danger"
                                      id="communication_sender_error"></span>
                            </div>
                            <!-- Form Group -->
                            <div class="form-group">
                                <input type="email" name="communication_email" id="communication_email"
                                       autocomplete="off"
                            ...
                            <!-- Form Group -->
                            <div class="form-group">
                                <input type="text" name="communication_title" id="communication_title"
                                       autocomplete="off"
