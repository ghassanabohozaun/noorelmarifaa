            ...
            <div class="row clearfix">
                ...
                <div class="content-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <h2>{!! trans('frontend.welcome_to') !!}
                            <span class="theme_color">{!! trans('frontend.nour_el_marifa') !!} </span>
                        </h2>
                        <div class="bold-text">
                            {!! trans('frontend.we_help_poor_people_to_get_their_life_better') !!}
                        </div>
                        <div class="text my_lead font-weight-boldest">
                            {!! trans('frontend.association_description') !!}
                        </div>
                        <a href="{!! route('contact.us') !!}" class="theme-btn btn-style-three">{!! trans('frontend.contact_us') !!}</a>
                    </div>
                </div>
            ...
            <div class="row clearfix">
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column wow zoomIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <img src="{!! asset('frontend/images/resource/faq.png') !!}" alt="{!! asset('frontend/images/resource/faq.png') !!}" />
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="sponsors-carousel owl-carousel owl-theme">
                        <li class="slide-item">
                            <figure class="image-box">
                                <a href="javascript:void(0)">
                                    <img src="{!! asset('frontend/images/clients/ACT.png') !!}" alt="{!! asset('frontend/images/clients/ACT.png') !!}">
                                </a>
                            </figure>
                        </li>
                        <li class="slide-item">
