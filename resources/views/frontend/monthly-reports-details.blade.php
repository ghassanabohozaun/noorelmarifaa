...
@section('content')
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class="title-column col-lg-6 col-md-12 col-sm-12">
                    <h1>{!! trans('frontend.monthly_report_for') !!} {!! $year !!} </h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="welcome-section">
        <div class="auto-container">
            ...
            @forelse($monthlyReportsForOneYear as $monthlyReportForOneYear)
                        ...
                        <div class="book_btn d-none d-lg-block">
                            <div class="download_brochure d-flex align-items-center justify-content-between">
                                ...
                                <div class="download_right">
                                    <a href="{!! asset(\Illuminate\Support\Facades\Storage::url($monthlyReportForOneYear->file)) !!}"
                                       class="boxed-btn3-line">
                                        {!! trans('frontend.month_report') !!} ( {!! $monthlyReportForOneYear->month !!} )
                                    </a>
                                </div>
                            </div>
                        </div>
