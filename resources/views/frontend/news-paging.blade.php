...
@else
    ...
    @foreach($posts as $post)
        ...
        <div class="news-block-four">
            <div class="inner-box">
                <div class="image">
                    <a href="{!! route('new', Lang()=='ar' ? str_replace(' ','-',$post->post_title_ar): str_replace(' ','-',$post->post_title_en)) !!}">
                        <img style="height: 420px"
                            src="{!! asset(Storage::url($post->photo)) !!}"
                ...
                <div class="lower-content">
                    <div class="content">
                        ...
                        <h3>
                            <a href="{!! route('new', Lang()=='ar' ? str_replace(' ','-',$post->post_title_ar): str_replace(' ','-',$post->post_title_en)) !!}">{!!  Lang()=='ar' ? $post->post_title_ar : $post->post_title_en !!}</a>
                        </h3>
                        <ul class="post-meta">
                            <li>
