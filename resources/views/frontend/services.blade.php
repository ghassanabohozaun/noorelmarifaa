    ...
    <section class="contact-section"
        ...
        <div class="auto-container">
            ...
            <div class="default-form contact-form">
                <form method="POST" action="{!! route('add.service') !!}" id="add_service_form">
                    @csrf
                    <div class="row clearfix">
                        ...
                        <div class="column col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="form-group">
                                <select name="service_type" id="service_type">
                                    <option value="sponsoring_an_orphan_student">
                                        {{trans('frontend.sponsoring_an_orphan_student')}}
                                    </option>

                                    <option value="sponsoring_a_needy_student">
                                        {{trans('frontend.sponsoring_a_needy_student')}}
                                    </option>

                                    <option value="financial_aid">
                                        {{trans('frontend.financial_aid')}}
                                    </option>
                                </select>
                                <span class="form-text text-danger" id="service_type_error"></span>
                            </div>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        swal({
                            icon: "success",
                            text: "{!! trans('frontend.success_add_service_order_message') !!}",
                            buttons: false,
                            timer: 3000,
                        });
