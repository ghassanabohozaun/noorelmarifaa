<div class="row mt-2">
    ...
    <div class="col-md-4">
        <ul class="list-group">
            ...
            <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                    class="text-dark">{!! __('children.father_full_name_ar') !!}:</strong>
                &nbsp;{!! $father_full_name_ar !!}
            </li>

            <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                    class="text-dark">{!! __('children.father_full_name_en') !!}:</strong>
                &nbsp;{!! $father_full_name_en !!}
            </li>
    ...
    <div class="col-md-4">
        <ul class="list-group">
            ...
            <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                    class="text-dark">{!! __('children.mother_full_name_ar') !!}:</strong>
                &nbsp;{!! $mother_full_name_ar !!}
            </li>

            <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong
                    class="text-dark">{!! __('children.mother_full_name_en') !!}:</strong>
                &nbsp;{!! $mother_full_name_en !!}
            </li>
