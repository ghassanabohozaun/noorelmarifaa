            ...
            <div class="content-header row">
                ...
                <div class="content-header-right col-md-6 col-12">
                    <div class="float-md-right mb-2">
                        <a href="{!! route('dashboard.pages.create') !!}" type="button" class="btn btn-info btn-glow px-2">
                                                    ...
                                                    <table id="yajra-datatable" class="table table-striped table-bordered">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-center">{!! __('pages.manage_status') !!}</th>
...
@push('scripts')
    <script type="text/javascript">
        ...
        $('#yajra-datatable').DataTable({
            ...
            ajax: '{!! route('dashboard.pages.get.all') !!}',
        ...
        $('body').on('click', '.delete_page_btn', function(e) {
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        url: '{!! route('dashboard.pages.destroy', ':id') !!}'.replace(':id', id),
                        data: {
                            '_token': "{!! csrf_token() !!}"
                        },
                        type: 'DELETE',
        ...
        $('body').on('change', '.change_status', function(e) {
            ...
            $.ajax({
                url: "{{ route('dashboard.pages.change.status') }}",
                data: {
