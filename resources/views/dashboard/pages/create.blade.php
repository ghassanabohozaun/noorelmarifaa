...
@section('content')
    <div class="app-content content">
        <form id="createPageForm" class="form" action="{!! route('dashboard.pages.store') !!}" method="post" enctype="multipart/form-data">
            @csrf
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-body">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="5" id="details_ar" name="details[ar]" class="form-control details_ar_summernote"
                                                                placeholder="{!! __('pages.enter_details_ar') !!}">{!! old('details.ar') !!}</textarea>
                                                            <span class="text text-danger">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea rows="5" id="details_en" name="details[en]" class="form-control details_en_summernote"
                                                                placeholder="{!! __('pages.enter_details_en') !!}">{!! old('details.en') !!}</textarea>
                                                            <span class="text text-danger">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="section">{!! __('pages.section') !!}</label>
                                                            <select class="form-control form-control-solid form-control-lg"
                                                                ...
                                                                <option value="beneficiaries_guide">
                                                                    {{ trans('pages.beneficiaries_guide') }}
                                                                </option>
                                                            ...
                                                            <span class="text text-danger">
                                                                <strong id="section_error"> </strong>
                                                            </span>
