...
@section('content')
    <div class="app-content content">
        ...
        <form class="form" action="{!! route('dashboard.posts.store') !!}" method="post" enctype="multipart/form-data" id="create_post_form">
            @csrf
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            ...
                                            <div class="tab-content mt-5">
                                                @include('dashboard.posts.create_tabs.settings')
                                                @include('dashboard.posts.create_tabs.details_ar')
                                                @include('dashboard.posts.create_tabs.details_en')
                                            </div>
                                        </div>
                                        <!-- end: card content -->
                                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == true) {
                        ...
                        $('.post_details_ar').summernote('code', '');
