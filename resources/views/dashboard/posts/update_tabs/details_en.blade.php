                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" id="post_title_en" name="post_title_en" class="form-control"
                            value="{!! $post->post_title_en !!}" autocomplete="off" placeholder="{!! __('posts.enter_post_title_en') !!}">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control" name="post_summary_en" id="post_summary_en" rows="3"
                            placeholder="{{ trans('posts.enter_post_summary_en') }}" autocomplete="off">{!! $post->post_summary_en !!}</textarea>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <textarea type="text" class="form-control post_details_en" name="post_details_en" id="post_details_en" rows="3"
                            placeholder="{{ trans('posts.enter_post_details_en') }}" autocomplete="off">{!! $post->post_details_en !!}</textarea>
