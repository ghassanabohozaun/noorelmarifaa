                    ...
                    <div class="my-5">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <input type="text" class="form-control form-control-solid form-control-lg"
                                    name="post_title_en" id="post_title_en" value="{!! $post->post_title_en !!}"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9 col-xl-9">
                                ...
                                <textarea type="text" class="form-control form-control-solid form-control-lg" name="post_summary_en"
                                    id="post_summary_en" rows="3" placeholder="{{ trans('posts.enter_post_summary_en') }}" autocomplete="off">{!! $post->post_summary_en !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="email" class="form-control form-control-solid form-control-lg post_details_ar"
                                placeholder="{{ trans('posts.enter_post_details_en') }}" name="post_details_en" id="post_details_en">{!! $post->post_details_en !!}</textarea>
