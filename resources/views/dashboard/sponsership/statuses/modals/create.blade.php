<div class="modal fade" id="createStatusModal" tabindex="-1" role="dialog" aria-labelledby="createStatusModalLabel"
    ...
    <div class="modal-dialog modal-md" role="document">
        <form class="form" action="{!! route('dashboard.sponsershipStatuses.store') !!}" method="POST" enctype="multipart/form-data"
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="createStatusModalLabel">{!! __('sponsership.create_new_status') !!}
                    </h5>
