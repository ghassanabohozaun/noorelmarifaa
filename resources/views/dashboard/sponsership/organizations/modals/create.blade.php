<div class="modal fade" id="createOrganizationModal" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-md" role="document">
        <form class="form" action="{!! route('dashboard.sponsershipOrganizations.store') !!}" method="POST" enctype="multipart/form-data"
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="createOrganizationModalLabel">{!! __('sponsership.create_new_organization') !!}
                    </h5>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" id="cancel_organization_btn" class="btn btn-light-dark font-weight-bold"
                        data-dismiss="modal">
...
@push('scripts')
    <script type="text/javascript">
        ...
        // cancel
        $('body').on('click', '#cancel_organization_btn', function(e) {
            $('#createOrganizationModal').modal('hide');
            $('#create_organization_form')[0].reset();
            resetCreateForm();
        });

        // hide
        $('#createOrganizationModal').on('hidden.bs.modal', function(e) {
            $('#createOrganizationModal').modal('hide');
            $('#create_organization_form')[0].reset();
            resetCreateForm();
        });
        ...
        // create
        $('#create_organization_form').on('submit', function(e) {
            e.preventDefault();
            // reset
            resetCreateForm();
