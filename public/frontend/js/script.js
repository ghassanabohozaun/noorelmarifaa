(function ($) {
    ...
    if ($(".main-slider-carousel").length) {
        $(".main-slider-carousel").owlCarousel({
            ...
            autoplay: 9000,
            navText: [
                '<span class="flaticon-back-5"></span>',
                '<span class="flaticon-next-7"></span>',
            ],
            responsive: {
                0: {
                    items: 1,
    ...
    if ($(".article-carousel").length) {
        $(".article-carousel").owlCarousel({
            ...
            autoplay: 5000,
            navText: [
                '<span class="fas fa-long-arrow-alt-left"></span> Prev',
        ...
        $(".time-countdown").each(function () {
            ...
            $this.countdown(finalDate, function (event) {
                var $this = $(this).html(
                    event.strftime(
                        "" +
                            '<div class="counter-column"><span class="count">%D</span><span class="unit">Days</div></div> ' +
                            '<div class="counter-column"><span class="count">%H</span><span class="unit">Hours</div></div>  ' +
                            '<div class="counter-column"><span class="count">%M</span><span class="unit">Mins</div></div>  ' +
                            '<div class="counter-column"><span class="count">%S</span><span class="unit">SECS</div></div>'
                    )
                );
            });
        });
